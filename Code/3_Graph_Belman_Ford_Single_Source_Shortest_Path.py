...
# Q: How's Belman Ford algo different from Dijkstra?
# A: Both algorithms compute the shortest path from a single source, however,
#    Dijkstra doesn't work when there's a negative edge edge.
